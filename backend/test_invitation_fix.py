        ...
        try:
            ...
            if lists_response.status_code != 200 or not lists_response.json():
                ...
                create_response = await client.post(
                    ...
                    json={
                        "name": "Test List",
                        "description": "Test list for invitation testing",
                    },
                )

                if create_response.status_code != 200:
                    print(
                        f"❌ Failed to create test list: {create_response.status_code}"
                    )
                    return
            ...
            if share_response.status_code == 200:
                ...
                print(
                    f"📋 List still has {len(response_data.get('members', []))} members (as expected)"
                )
