...
async def test_optimized_performance():
    ...
    print("=" * 60)
    print(
        "Testing complete optimization: gemini-1.5-flash + 6-month caching + parallel processing"
    )
    print()
    ...
    test_cases = [
        ...
        {
            "name": f"unique_test_{random.randint(10000, 99999)}",
            "expected": "fast AI call",
            "type": "new_item",
        },
    ]
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        try:
            ...
            category = await ai_service.suggest_category_async(
