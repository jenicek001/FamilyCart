...
class WebSocketService:
    ...
    async def notify_item_created(self, list_id: int, item_data: Dict[str, Any], user_id: str):
    ...
    async def notify_item_updated(self, list_id: int, item_data: Dict[str, Any], user_id: str):
    ...
    async def notify_list_updated(self, list_id: int, list_data: Dict[str, Any], user_id: str):
    ...
    async def notify_list_shared(self, list_id: int, list_data: Dict[str, Any], new_member_email: str, user_id: str):
        """Notify list members that the list was shared with someone new"""
        if not self._connection_manager:
            return
            
        list_data_with_member = {
            **list_data,
    ...
    async def notify_member_removed(self, list_id: int, removed_user_id: str, user_id: str):
    ...
    async def notify_category_changed(self, list_id: int, item_data: Dict[str, Any], user_id: str):
