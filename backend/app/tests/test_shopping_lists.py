...
async def test_get_shopping_lists(
    client: AsyncClient, token_header, test_shopping_list
):
    """Test getting all shopping lists for a user."""
    response = await client.get("/api/v1/shopping-lists/", headers=token_header)
...
async def test_get_shopping_list(client: AsyncClient, token_header, test_shopping_list):
    ...
    response = await client.get(
        f"/api/v1/shopping-lists/{test_shopping_list.id}", headers=token_header
    )
...
@pytest.mark.asyncio
async def test_get_items_from_shopping_list(
    client: AsyncClient, token_header, test_shopping_list
):
    """Test getting items from a shopping list."""
    response = await client.get(
        f"/api/v1/shopping-lists/{test_shopping_list.id}/items", headers=token_header
    )
