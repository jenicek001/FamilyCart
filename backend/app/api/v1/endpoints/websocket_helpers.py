...
class WebSocketNotifier:
    ...
    @staticmethod
    async def notify_item_created(list_id: int, item_data: Dict[str, Any], user_id: str):
    ...
    @staticmethod
    async def notify_item_updated(list_id: int, item_data: Dict[str, Any], user_id: str):
    ...
    @staticmethod
    async def notify_list_updated(list_id: int, list_data: Dict[str, Any], user_id: str):
