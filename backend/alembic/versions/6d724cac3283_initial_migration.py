...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_category_translation_lang_code'), 'category_translation', ['lang_code'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_category_translation_lang_code'), table_name='category_translation')
