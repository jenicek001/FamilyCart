...
async def test_login_flow():
    ...
    async with httpx.AsyncClient() as client:
        ...
        try:
            ...
            print(f"✅ User data fetched: {user_data.get('email')} ({user_data.get('first_name')})")
        ...
        try:
            lists_response = await client.get(f"{base_url}/api/v1/shopping-lists", headers=headers)
