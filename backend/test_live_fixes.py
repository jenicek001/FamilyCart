...
class LiveTester:
    ...
    def authenticate(self) -> bool:
        ...
        try:
            ...
            login_response = self.session.post(f"{API_BASE}/auth/jwt/login", data=login_data)
    ...
    def create_shopping_list(self) -> bool:
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                logger.error(f"Failed to create shopping list: {response.status_code} - {response.text}")
                return False
    ...
    def add_item(self, name: str, quantity: str = "1 ks") -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Item add result: {result['success']} (HTTP {result['status_code']})")
            return result
